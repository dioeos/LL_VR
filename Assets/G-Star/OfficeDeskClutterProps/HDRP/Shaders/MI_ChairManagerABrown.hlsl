...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(1.000000,1.000000,1.500329,1.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local7 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)Material.PreshaderBuffer[2].w));
	...
	MaterialFloat2 Local11 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)Material.PreshaderBuffer[3].x));
	MaterialFloat Local12 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local11), 1);
	MaterialFloat4 Local13 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local11),View.MaterialTextureMipBias));
	MaterialFloat Local14 = MaterialStoreTexSample(Parameters, Local13, 1);
	MaterialFloat Local15 = (Local13.b * Material.PreshaderBuffer[3].y);
	MaterialFloat Local16 = (Local13.g * Material.PreshaderBuffer[3].z);
	MaterialFloat Local17 = (Local13.r * Material.PreshaderBuffer[3].w);
