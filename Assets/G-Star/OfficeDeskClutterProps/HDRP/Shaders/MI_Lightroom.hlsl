...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.347655,0.368281,0.375000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.347655,0.368281,0.375000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = lerp(Material.PreshaderBuffer[2].xyz,Material.PreshaderBuffer[3].xyz,Material.PreshaderBuffer[2].w);
	...
	MaterialFloat3 Local5 = (Local3.rgb * Material.PreshaderBuffer[5].xyz);
