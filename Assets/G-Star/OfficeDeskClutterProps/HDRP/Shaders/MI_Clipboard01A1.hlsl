...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.067708,0.067708,0.067708,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.067708,0.067708,0.067708,1.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local9 = lerp(Local6.rgb,((MaterialFloat3)Local8),Material.PreshaderBuffer[3].y);
	MaterialFloat3 Local10 = (Local9 * ((MaterialFloat3)Material.PreshaderBuffer[3].z));
	MaterialFloat3 Local11 = (Local10 * Material.PreshaderBuffer[5].xyz);
	MaterialFloat3 Local12 = PositiveClampedPow(Local11,((MaterialFloat3)Material.PreshaderBuffer[5].w));
